"""
Train the Hybrid CNN + Transformer model on HAM10000 for binary classification.
...
def main():
    ...
    MODEL_SAVE_PATH = "weights/hybrid_model.pth"
    WEIGHTS_SAVE_PATH = "weights/hybrid_weights.pth"
