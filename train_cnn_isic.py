"""
Train the Baseline CNN (ResNet50) on ISIC dataset for binary classification.

Mirrors the HAM10000 `train_cnn.py` with identical hyperparameters.
...
def main():
    ...
    # ---------- Prepare data ----------
    print("=" * 60)
    print("BASELINE CNN TRAINING (ResNet50) — ISIC DATASET")
    print("=" * 60)
